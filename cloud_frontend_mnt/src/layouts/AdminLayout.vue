  ...
  return [
    {
      ...
      children: [
        { to: '/users', name: 'users', label: t('nav.users'), icon: 'users' },
        { to: '/phones', name: 'phones', label: t('nav.phones'), icon: 'phones' },
      ],
    },
    {
      id: 'lots',
      label: t('nav.sectionLots'),
      children: [
      ...
      children: [
        {
          to: '/parking-orders',
          name: 'parkingOrders',
          label: t('nav.parkingOrders'),
          icon: 'parkingOrders',
        },
        {
          to: '/parking-records',
          name: 'parkingRecords',
          label: t('nav.parkingRecords'),
          icon: 'parkingRecords',
        },
        {
          to: '/on-site-vehicles',
          name: 'onSiteVehicles',
          label: t('nav.onSiteVehicles'),
          icon: 'onSiteVehicles',
        },
        {
          to: '/entry-exit-records',
          name: 'entryExitRecords',
          label: t('nav.entryExitRecords'),
          icon: 'entryExitRecords',
        },
      ],
    },
    {
      ...
      children: [
        { to: '/whitelist', name: 'whitelist', label: t('nav.whitelist'), icon: 'whitelist' },
        { to: '/blacklist', name: 'blacklist', label: t('nav.blacklist'), icon: 'blacklist' },
      ],
    },
    {
      id: 'billing',
      ...
      children: [
        ...
        { to: '/rate-rules', name: 'rateRules', label: t('nav.rateRules'), icon: 'rateRules' },
        {
          to: '/monthly-plans',
          name: 'monthlyPlans',
          label: t('nav.monthlyPlans'),
          icon: 'monthlyPlans',
        },
      ],
    },
    {
      ...
      children: [
        ...
        { to: '/bills', name: 'bills', label: t('nav.bills'), icon: 'bills' },
        {
          to: '/reconciliation',
          name: 'reconciliation',
...
const expandedGroups = ref<string[]>(['platform', 'lots', 'parking', 'access', 'billing', 'finance', 'system'])
          ...
          <div v-show="isExpanded(group.id)" class="nav-children">
            ...
            >
              <span class="icon" aria-hidden="true">
                ...
                <svg v-else-if="item.icon === 'phones'" viewBox="0 0 24 24" fill="none">
                ...
                <svg v-else-if="item.icon === 'parkingOrders'" viewBox="0 0 24 24" fill="none">
                  <path
                ...
                <svg v-else-if="item.icon === 'parkingRecords'" viewBox="0 0 24 24" fill="none">
                  <path
                ...
                <svg v-else-if="item.icon === 'onSiteVehicles'" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M5 17h14M6 17l1.2-4.5a2 2 0 0 1 1.9-1.5h7.8a2 2 0 0 1 1.9 1.5L19 17"
                    stroke="currentColor"
                    stroke-width="1.8"
                  ...
                  <circle cx="16.5" cy="17" r="1.5" stroke="currentColor" stroke-width="1.8" />
                </svg>
                <svg v-else-if="item.icon === 'entryExitRecords'" viewBox="0 0 24 24" fill="none">
                  <path
                ...
                <svg v-else-if="item.icon === 'billingPlans'" viewBox="0 0 24 24" fill="none">
                  <path
                    ...
                    stroke-linecap="round"
                  />
                  <circle cx="8" cy="7" r="2" stroke="currentColor" stroke-width="1.8" />
                  <circle cx="16" cy="12" r="2" stroke="currentColor" stroke-width="1.8" />
                </svg>
                <svg v-else-if="item.icon === 'rateRules'" viewBox="0 0 24 24" fill="none">
                  <path d="M4 20V10M9 20V6M14 20v-8M19 20V4" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" />
                </svg>
                <svg v-else-if="item.icon === 'monthlyPlans'" viewBox="0 0 24 24" fill="none">
                ...
                <svg v-else-if="item.icon === 'paymentOrders'" viewBox="0 0 24 24" fill="none">
                  <rect x="3" y="6" width="18" height="12" rx="2" stroke="currentColor" stroke-width="1.8" />
                ...
                <svg v-else-if="item.icon === 'bills'" viewBox="0 0 24 24" fill="none">
                  <path
                ...
                <svg v-else-if="item.icon === 'reconciliation'" viewBox="0 0 24 24" fill="none">
                ...
                <svg v-else-if="item.icon === 'admins'" viewBox="0 0 24 24" fill="none">
                  <circle cx="9" cy="8" r="3" stroke="currentColor" stroke-width="1.8" />
                  <path d="M4 19a5 5 0 0 1 10 0" stroke="currentColor" stroke-width="1.8" />
                  <circle cx="17" cy="9" r="2.2" stroke="currentColor" stroke-width="1.8" />
                  <path d="M16 19a4 4 0 0 1 4-4" stroke="currentColor" stroke-width="1.8" />
