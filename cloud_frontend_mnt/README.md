...
Vue 3 admin console for the FreePark cloud platform. Uses `vue-i18n` and talks to [`cloud_server`](../cloud_server/README.md).

FreePark 云端管理界面，基于 Vue 3 + vue-i18n，对接 `cloud_server`。
