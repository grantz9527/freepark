  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        {
          to: '/pattern-allowlist',
          name: 'patternAllowlist',
          label: t('nav.patternAllowlist'),
          icon: 'patternAllowlist',
        },
        {
          to: '/access-judgment',
          name: 'accessJudgment',
          label: t('nav.accessJudgment'),
          icon: 'accessJudgment',
        },
      ],
    },
          ...
          <div v-show="group.children.length > 0 && isExpanded(group.id)" class="nav-children">
            ...
            >
              <span class="icon" aria-hidden="true">
                ...
                <svg v-else-if="item.icon === 'patternAllowlist'" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M5 8h6M5 12h14M5 16h10M15 6l4 4-4 4"
                    stroke="currentColor"
                    stroke-width="1.8"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                ...
                <svg v-else-if="item.icon === 'accessJudgment'" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M5 7h14M5 12h14M5 17h14M8 9V5M12 14V10M16 19V15"
                    stroke="currentColor"
                    stroke-width="1.8"
                    stroke-linecap="round"
                    stroke-linejoin="round"
