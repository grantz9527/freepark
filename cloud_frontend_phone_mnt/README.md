# cloud_frontend_phone_mnt

Vue 3 mobile management app for the FreePark cloud platform. Uses `vue-i18n` and talks to [`cloud_server`](../cloud_server/README.md).

FreePark 云端手机管理端，基于 Vue 3 + vue-i18n，对接 `cloud_server`。
...
Dev server: [http://localhost:5176](http://localhost:5176)
