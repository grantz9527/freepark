...
public enum ErrorCode {
    ...
    STREAM_URL_INVALID("error.stream.invalid-url", HttpStatus.BAD_REQUEST),
    STREAM_PREVIEW_FAILED("error.stream.preview-failed", HttpStatus.BAD_GATEWAY),
    STREAM_PREVIEW_BUSY("error.stream.preview-busy", HttpStatus.TOO_MANY_REQUESTS),
    ...
    FEE_API_NOT_CONFIGURED("error.fee.api-not-configured", HttpStatus.BAD_REQUEST),
    FEE_API_CALL_FAILED("error.fee.api-call-failed", HttpStatus.BAD_GATEWAY),
    INVALID_FEE_MOCK_CONFIG("error.fee.invalid-mock-config", HttpStatus.BAD_REQUEST),
    ...
    SOFTWARE_PLATE_UPSTREAM_FAILED("error.software-plate.upstream-failed", HttpStatus.BAD_GATEWAY),
